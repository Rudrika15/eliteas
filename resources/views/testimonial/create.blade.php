                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-floating">
                            <select class="form-select @error('circleId') is-invalid @enderror" id="circleId" name="circleId" required>
                                ...
                                <option value="digital">Digital Member</option>
                                @if (old('circleId'))
                            ...
                            <select class="form-select @error('memberId') is-invalid @enderror" id="memberId" name="memberIdSelect" required>
                                ...
                                @else
                                    @foreach ($circleMember as $member)
                                        <option value="{{ $member->id }}" data-user-id="{{ $member->userId }}" data-first-name="{{ $member->firstName }}" data-last-name="{{ $member->lastName }}">
