...
<div class="col-12 col-sm-6 col-lg-6">
    <div class="profile-card shadow-sm rounded border-0">
        ...
        <div class="text-center p-3">
            <img src="{{ asset('ProfilePhoto/' . ($member->receiver->profilePhoto ?? 'profile.png')) }}"
            ...
            <div class="company-category-section">
                <div class="company-section">
                    <div class="logo-section">
                        ...
                        <img src="{{ asset('CompanyLogo/' . $member->receiverMember->companyLogo) }}"
                            class="company-logo" alt="Company Logo">
                        @endif
                        <div class="initials"
                            style="{{ empty($member->receiverMember->companyLogo) ? 'display:flex;' : 'display:none;' }}">
        ...
        <div class="bottom-actions">
            <div id="viewProfile" class="action-button left-action">
                <a href="{{ route('foundPersonDetails', $member->receiverMember->id) }}">
                    <i class="bi bi-person-lines-fill" style="color: #1d3268;"></i><span style="color: #1d3268;">View
                        Profile</span>
                </a>
            </div>
