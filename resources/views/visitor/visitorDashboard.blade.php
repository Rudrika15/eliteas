                    ...
                    <div class="card-body">
                        ...
                        @if ($eventRegister)
                            ...
                            @if ($nearestEvents->slot_date)
                                @php
                                    $isSlotBooked = \App\Models\SlotBooking::where('eventId', $nearestEvents->id)->where('visitorId', $visitor)->exists();
                                @endphp
                                <div class="d-flex justify-content-end mt-3">
                                    @if ($isSlotBooked)
                                        <button type="button" class="btn btn-bg-orange btn-md" id="viewMembers" onclick="location.href='{{ route('event.viewMembersForVisitors', ['id' => $nearestEvents->id]) }}'">
                                            View Members
                                        </button>
                                    @elseif (\Carbon\Carbon::parse($nearestEvents->slot_date)->format('Y-m-d') == \Carbon\Carbon::today()->format('Y-m-d'))
                                        <button type="button" class="btn btn-bg-orange btn-md" id="slotBooking" onclick="location.href='{{ route('event.viewMembersForVisitors', ['id' => $nearestEvents->id]) }}'">
                                            Slot Booking
                                        </button>
                                    @endif
                                </div>
                        ...
                        @else
                            ...
                            @else
                                ...
                                <div class="d-flex justify-content-end">
                                    <button type="button" class="btn btn-bg-orange btn-md" id="razorpayBtnEvent" data-amount-event="{{ $nearestEvents->visitorFees }}" data-original-amount="{{ $nearestEvents->visitorFees }}">
                                        Join Now
                                    </button>
                                </div>
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" id="proceedToPayment" class="btn btn-bg-orange" disabled>Proceed
                                                    to Payment</button>
                                            </div>
                                        </div>
                                    </div>
