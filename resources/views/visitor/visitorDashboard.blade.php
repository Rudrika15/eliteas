            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-10">
                        ...
                        \Carbon\Carbon::parse($nearestEvents->event_date)->format('j M Y') }} <br>
                    </div>
                ...
                <div class="d-flex justify-content-end mt-3">
                    ...
                    @elseif (\Carbon\Carbon::parse($nearestEvents->slot_date)->format('Y-m-d') ==
                ...
                <div class="d-flex justify-content-end">
                    <button type="button" class="btn btn-bg-orange btn-md" id="razorpayBtnEvent"
                        data-amount-event="{{ $nearestEvents->visitorFees }}"
                        data-original-amount="{{ $nearestEvents->visitorFees }}">
                        Join Now
                    </button>
                </div>
