                        ...
                        <div class="card-body">
                            <div class="d-flex flex-column align-items-center text-center">
                                ...
                                @if ($profilePhoto && file_exists(public_path('ProfilePhoto/' . $profilePhoto)))
                                    <img src="{{ asset('ProfilePhoto/' . $profilePhoto) }}" alt="ProfilePhoto" class="rounded-circle" width="150">
                                @else
                                    <img src="{{ asset('ProfilePhoto/profile.png') }}" alt="ProfilePhoto" class="rounded-circle" width="100">
                                @endif
                                <div class="mt-3">
                                    ...
                                    @if (!$connection)
                                        <form action="{{ route('connect') }}" id="connectForm" method="POST">
                                            ...
                                            <button type="submit" class="btn btn-bg-blue shadow-none">Connect &nbsp;<i class="bi bi-person-plus-fill"></i></button>
                                        </form>
                                    @elseif ($connection->status == 'Accepted')
                                        <button type="button" class="btn btn-bg-blue shadow-none">Connected &nbsp;<i class="bi bi-check-circle-fill"></i></button>
                                    @elseif ($connection->status == 'Rejected')
                                        <button type="submit" class="btn btn-bg-blue shadow-none">Connect &nbsp;<i class="bi bi-person-plus-fill"></i></button>
                                    @else
                                        <button type="button" class="btn btn-bg-blue shadow-none">Requested &nbsp;<i class="bi bi-clock"></i></button>
                                    @endif
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" id="myTabs" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active text-blue" id="profile-tab" data-bs-toggle="tab" data-bs-target="#profile" type="button" role="tab" aria-controls="profile" aria-selected="true">My Profile</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link  text-blue" id="bios-tab" data-bs-toggle="tab" data-bs-target="#bios" type="button" role="tab" aria-controls="bios" aria-selected="true">My Bios</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link text-blue" id="tops-tab" data-bs-toggle="tab" data-bs-target="#tops" type="button" role="tab" aria-controls="tops" aria-selected="false">Tops Profile</button>
                                </li>
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link text-blue" id="gains-tab" data-bs-toggle="tab" data-bs-target="#gains" type="button" role="tab" aria-controls="gains" aria-selected="false">Gains Profile</button>
                                </li>
                            </ul>
                            <!-- Tab panes -->
