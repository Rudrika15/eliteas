    ...
    <div class="container my-4">
        <div class="profile-wrapper shadow">
            ...
            @php
                ...
                $viewedIsDigitalMember = $member->user && ($member->user->hasRole('Digital Member') || ($member->user->role ?? '') == 'Digital Member');
                $canViewDigitalContacts = $authIsCircleMember && !empty($userCircleId) && $viewedIsDigitalMember && empty($memberCircleId);
            @endphp
            ...
            <div class="row px-4 pb-4 g-3">
                ...
                <div class="col-md-4">
                    <div class="card-section h-100">
                        ...
                        <div class="{{ (!empty($memberCircleId) && $memberCircleId == $userCircleId) || ($connection && $connection->status == 'Accepted') || $canViewDigitalContacts || (empty($memberCircleId) && !empty($userCircleId)) ? '' : 'blurred-info' }}">
                ...
                <div class="col-md-4">
                    <div class="card-section h-100">
                        ...
                        @if ($companyLogo && file_exists(public_path('CompanyLogo/' . $companyLogo)))
                            <p><img src="{{ asset('CompanyLogo/' . $companyLogo) }}" alt="Logo" class="me-2" style="width: 100px; height: 100px; object-fit: contain; aspect-ratio: 1/1;"><br><strong class="text-color">{{ $member->companyName ?? 'N/A' }}</strong></p>
                        @else
                            <p><img src="{{ asset('ProfilePhoto/profile.png') }}" alt="Logo" class="me-2" style="width: 100px; height: 100px; object-fit: contain; aspect-ratio: 1/1;"><br><strong class="text-color">{{ $member->companyName ?? 'N/A' }}</strong></p>
                        @endif
                ...
                @if ($member->user->role == 'Member')
                    ...
                    <div class="col-md-4">
                        <div class="row g-3 position-relative">
                            <div class="{{ (!empty($memberCircleId) && $memberCircleId == $userCircleId) || ($connection && $connection->status == 'Accepted') || (empty($memberCircleId) && !empty($userCircleId)) ? '' : 'blurred-info' }}">
                                <div class="row g-3">
                                    <div class="col-6">
            ...
            <div class="row g-4">
                ...
                <div class="col-md-6">
                    <div class="card shadow border-0 rounded-4 h-100">
                        ...
                        <div class="card-body">
                            @if (isset($member->memberGallery) && $member->memberGallery->count() > 0)
                                <div class="row g-3">
                                    @foreach ($member->memberGallery as $gallery)
                                        @if ($gallery->status == 'Active' && !empty($gallery->image) && file_exists(public_path('MemberGallery/' . $gallery->image)))
                                            <div class="col-6">
                                                <div class="gallery-card">
                                                    <img src="{{ asset('MemberGallery/' . $gallery->image) }}" class="img-fluid rounded-3 shadow-sm gallery-img" alt="Gallery Image">
                                                </div>
                                            </div>
                                        @endif
                                    @endforeach
                ...
                <div class="col-md-6">
                    <div class="card shadow border-0 rounded-4 h-100">
                        ...
                        <div class="card-body">
                                        ...
                                        <div class="testimonial-box mb-3">
                                            ...
                                            <div class="d-flex align-items-center mb-2">
                                                ...
                                                <div class="testimonial-avatar">
                                                    ...
                                                    {{ strtoupper(substr(optional($testimonial->user)->firstName ?? 'U', 0, 1)) }}
                                                ...
                                                <div class="ms-2">
                                                    ...
                                                    <h6 class="mb-0 fw-bold text-color">
                                                        ...
                                                        {{ optional($testimonial->user)->firstName ?? 'Unknown' }}
                                                        {{ optional($testimonial->user)->lastName ?? '' }}

                                                    </h6>

                                                    <small class="text-muted">

                                                        {{ $testimonial->created_at ? $testimonial->created_at->format('d M Y') : '' }}
                            ...
                            @else
                                <div class="text-center py-5">
                                    <i class="bi bi-chat-left-text text-muted" style="font-size:50px;"></i>
                                    <p class="mt-3 text-muted mb-0">
