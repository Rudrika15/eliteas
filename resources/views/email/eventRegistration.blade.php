...
<head>
    ...
    <style type="text/css">
        ...
        .email-body {
            ...
            color: #555;
            margin: 0 10px;
            /* Added margin to avoid text touching the page border */
        }
                    ...
                    <tr class="email-header">
                        <td>
                            <a href="{{ url('/') }}" target="_blank">
                                <img src="{{ asset('img/logo2.jpg') }}" alt="Company Logo">
                            </a>
                        </td>
                    </tr>
                    <tr class="email-body">
                        <td>
                            ...
                            <ul>
                                <li><strong>Event Name:</strong> {{ $eventDetails['title'] }}</li>
                                <li><strong>Date:</strong>
                                    {{ \Carbon\Carbon::parse($eventDetails['event_date'])->format('d-m-Y') }}</li>
                                <li><strong>Location:</strong> {{ $eventDetails['venue'] }}</li>
                            </ul>
                    ...
                    <tr class="footer">
                        <td>
                            ...
                            <p>If you have any questions or need assistance, feel free to contact us at <a
                                    href="mailto:support@ubncommunity.com">support@ubncommunity.com</a></p>
                        </td>
                    </tr>
                </table>
            </td>
