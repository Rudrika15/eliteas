    ...
    <li class="nav-item">
        ...
        <ul id="reports-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
            ...
            @if (Auth::user()->hasRole('Attendance Handler'))
                <li>
                    <a href="{{ route('attendance.meetingSchedules') }}">
            ...
            @endif
            <li>
                <a href="{{ route('admin.report.vpcircleMember') }}">
                    <i class="bi bi-circle"></i><span>Circle Member Report</span>
                </a>
            </li>
        </ul>
    </li>
...
@role('Digital Member')
    ...
    <a class="nav-link collapsed" href="{{ route('topNetworkers.index') }}">
        <i class="bi bi-trophy" style="color: #e76a35"></i>
        <span style="color: #1d2865 ;">Top Networkers</span>
    </a>
...
@role('Member')
    ...
    <a class="nav-link collapsed" data-bs-target="#connection-nav" data-bs-toggle="collapse" href="#">
        <i class="bi bi-person-heart" style="color: #e76a35"></i><span>My Network</span><i
            class="bi bi-chevron-down ms-auto" style="color: #e76a35"></i>
    </a>
