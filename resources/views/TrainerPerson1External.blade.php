<button type="button" class="btn btn-primary " data-bs-toggle="modal" data-bs-target="#trainerMaster">
    Select External Trainer Member
</button>

<!-- Modal -->
<div class="modal fade" id="trainerExternal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
            ...
            <div class="modal-body ">
                ...
                <div class="row d-flex  justify-content-center ">
                    ...
                    <div class="col-md-12 p-3 ">
                        <div class="externalTrainersList">
