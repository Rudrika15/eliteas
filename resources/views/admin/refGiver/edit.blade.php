...
@section('content')
    ...
    <div class="card">
        ...
        <form class="m-3 needs-validation" id="callForm" enctype="multipart/form-data" method="post"
            ...
            @csrf
            <input type="hidden" name="id" value="{{ $refGiver->id }}">
            <div class="row mb-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <div class="form-floating mt-6">
                        <input type="text" class="form-control @error('referenceGiver') is-invalid @enderror"
                            id="referenceGiver" name="referenceGiver" value="{{ $refGiver->referenceGiver }}"
                            placeholder="Reference Giver" required>
                ...
                <div class="col-md-6">
                    <div class="form-floating mt-3">
                        <input type="text" class="form-control @error('contactName') is-invalid @enderror"
                            id="contactName" name="contactName" value="{{ $refGiver->contactName }}"
                ...
                <div class="col-md-6">
                    <div class="form-floating mt-3">
                        <input type="text" class="form-control @error('contactNo') is-invalid @enderror" id="contactNo"
                            name="contactNo" placeholder="Contact No" value="{{ $refGiver->contactNo }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-floating mt-3">
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="email"
                            name="email" placeholder="email" value="{{ $refGiver->email }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-floating mt-3">
                        <input type="text" class="form-control @error('scale') is-invalid @enderror" id="scale"
                            name="scale" placeholder="scale" value="{{ $refGiver->scale }}" required>
                ...
                <div class="col-md-6">
                    <div class="form-floating mt-3">
                        <input type="text" class="form-control @error('description') is-invalid @enderror"
                            ...
                            name="{{ $refGiver->description }}" required>
