                                ...
                                @foreach ($schedules as $scheduleData)
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            ...
                                            <a href="{{ route('attendance.invitedAttendance', $scheduleData->id) }}" class="btn btn-bg-blue btn-tooltip">
                                                <i class="bi bi-person-fill-check"></i>
                                                <span class="btn-text">External Attendance</span>
                                            </a>
                                            <a href="{{ route('attendance.attendanceList', $scheduleData->id) }}" class="btn btn-bg-orange btn-tooltip">
