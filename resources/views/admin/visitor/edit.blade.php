...
<div class="card">
    ...
    <form class="m-3 needs-validation" id="visitorsForm" enctype="multipart/form-data" method="post"
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" class="form-control @error('mobileNo') is-invalid @enderror" id="mobileNo"
                        name="mobileNo" value="{{ $visitors->mobileNo }}" placeholder="Mobile No" pattern="[0-9]{10}"
            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" class="form-control" id="businessName" name="businessName"
                        placeholder="Business Name" value="{{ $visitors->businessName }}">
        ...
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-floating">
                    <select class="form-select @error('businessCategoryId') is-invalid @enderror" id="businessCategory"
                        name="businessCategoryId">
                        <option value="" disabled>Select Business Category</option>
                        @foreach ($businessCategories as $businessCategoryData)
                        <option value="{{ $businessCategoryData->id }}" {{ old('businessCategory', $visitors->
                            businessCategory) == $businessCategoryData->id ? 'selected' : '' }}>
