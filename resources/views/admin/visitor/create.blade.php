    ...
    <div class="card">
        ...
        <form class="m-3 needs-validation" id="visitorForm" enctype="multipart/form-data" method="post" action="{{ route('visitors.store') }}" novalidate>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('mobileNo') is-invalid @enderror" id="mobileNo" name="mobileNo" placeholder="Mobile No" pattern="[0-9]{10}" oninput="if(this.value.length > 10) this.value = this.value.slice(0,10); this.value = this.value.replace(/[^0-9]/g, '').replace(/(\..*)\./g, '$1');" oninvalid="this.setCustomValidity('Please enter a valid 10-digit mobile number');" oninput="this.setCustomValidity('')">
            ...
            <div class="row mb-3">
                <div class="col-md-12">
                    <div class="form-floating">
                        <textarea class="form-control" id="otherDetails" name="otherDetails" placeholder="otherDetails"></textarea>
