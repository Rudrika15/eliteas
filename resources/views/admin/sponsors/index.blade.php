        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('sponsors.create') }}" class="btn btn-bg-orange btn-sm mt-3 btn-tooltip"><i class="bi bi-plus-circle"></i>
                        <span class="btn-text">Add Sponsor</span>
                    </a>
                </div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($sponsors as $sponsorData)
                                <tr>
                                    <td>
                                        {{ ($sponsors->currentPage() - 1) * $sponsors->perPage() + $loop->iteration }}
                                    </td>

                                    <td>{{ $sponsorData->title ?? '-' }}</td>

                                    <td>
                                        @if ($sponsorData->image)
                                            <img src="{{ asset('sponsors/' . $sponsorData->image) }}" alt="{{ $sponsorData->title }}" width="150" height="100" style="object-fit: cover; border-radius: 5px;">
                                        @else
                                            -
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        <a href="{{ route('sponsors.edit', $sponsorData->id) }}" class="btn btn-bg-blue btn-sm btn-tooltip">
                                            <i class="bi bi-pen"></i>
                                            <span class="btn-text">Edit</span>
                                        </a>

                                        <a href="{{ route('sponsors.delete', $sponsorData->id) }}" class="btn btn-danger btn-sm btn-tooltip" onclick="return confirm('Are you sure you want to delete this sponsor?')">
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="membersModalLabel">Banner </h5>
