    ...
    <div class="card">
        ...
        <form class="m-3 needs-validation" id="cityForm" enctype="multipart/form-data" method="post" action="{{ route('circlemember.store') }}" novalidate>
            ...
            <div class="row mb-3">
                <div class="col-md-6">
                    <div class="form-floating">
                        <select class="form-select" data-error='Circle Field is required' required name="circleIds" id="circleIds">
            ...
            <div class="row">
                <div class="col-md-6 mt-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('firstName') is-invalid @enderror" id="firstName" name="firstName" placeholder="First Name" required value="{{ old('firstName') }}">
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-floating">
                        <input type="text" class="form-control @error('lastName') is-invalid @enderror" id="lastName" name="lastName" placeholder="Last Name" required value="{{ old('lastName') }}">
            ...
            <div class="row">
                <div class="col-md-6 mt-3">
                    <div class="form-floating">
                        <select class="form-select @error('title') is-invalid @enderror" id="title" name="title" {{ old('title') ? 'value="' . old('title') . '"' : '' }} required>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="membershipAmount" name="membershipAmount" placeholder="Membership Amount" readonly>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="discountAmount" name="discountAmount" value="1" onchange="toggleFields(this)">
                ...
                <div class="col-md-6 mt-3" id="discountedAmountContainer" style="display:none;">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="discountedAmount" name="discountedAmount" placeholder="Discounted Amount" value="{{ old('discountedAmount') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-floating">
                        <input type="text" class="form-control" id="date" name="date" placeholder="Date" readonly value="{{ date('Y-m-d') }}">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-3">
                    <div class="form-check">
                        <input class="form-check-input" type="checkbox" id="paymentModeCheck" name="paymentModeCheck" value="1" onchange="togglePaymentMode(this)">
            ...
            <div class="row" id="paymentModeContainer" style="display:none;">
                <div class="col-md-6 mt-3">
                    <div class="form-floating">
                        <select class="form-select @error('paymentMode') is-invalid @enderror" id="paymentMode" name="paymentMode">
