                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select" data-error='Circle Name Field is required' required name="circleIds" id="circleIds">
                                                <option value="" selected disabled> Select Circle </option>
                                                @foreach ($circles as $circleData)
                                                    <option value="{{ $circleData->id }}" {{ old('circleIds', $member->circleId) == $circleData->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="isSponsered" name="isSponsered" {{ old('isSponsered', $member->sponsoredBy) ? 'checked' : '' }}>
                                    ...
                                    <div class="row mt-3" id="sponsorSection">
                                        <div class="col-md-6">
                                            <div class="form-floating">
                                    ...
                                    <script>
                                        $(document).ready(function() {
                                            ...
                                            $('#isSponsered').on('change', function() {
                                                if ($(this).is(':checked')) {
                                                    $('#sponsorSection').slideDown();
                                                } else {
                                                    $('#sponsorSection').slideUp();
                                                }
                                            });
                                        });
                                    </script>
