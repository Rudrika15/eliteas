                        ...
                        <select class="form-select @error('businessCategory') is-invalid @enderror" id="businessCategory"
                            ...
                            @foreach ($businessCategory as $businessCategoryData)
                                <option value="{{ $businessCategoryData->id }}"
                                    {{ old('businessCategoryId', $member->businessCategoryId) == $businessCategoryData->id ? 'selected' : '' }}>
                    ...
                    <div class="form-floating mt-3">
                        <select class="form-select @error('membershipType') is-invalid @enderror" id="membershipType"
                            ...
                            @foreach ($membershipType as $membershipTypeData)
                                <option value="{{ $membershipTypeData->id }}"
                                    {{ $member->membershipType == $membershipTypeData->id ? 'selected' : '' }}>
                                    ...
                                    <div class="col-md-6 mt-3">
                                        <div class="form-floating">
                                            <select class="form-select @error('title') is-invalid @enderror" id="title"
                                                ...
                                                <option value="Mr."
                                                    {{ old('title', $member->title) === 'Mr.' ? 'selected' : '' }}>
                                                    Mr.</option>
                                                <option value="Ms."
                                                    {{ old('title', $member->title) === 'Ms.' ? 'selected' : '' }}>
                                                    Ms.</option>
                                                <option value="Mrs."
                                                    {{ old('title', $member->title) === 'Mrs.' ? 'selected' : '' }}>
                                                    Mrs.</option>
                                            </select>
                                            <label for="title">Title</label>
                                            @error('title')
                            ...
                            <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour"
                                ...
                                <div class="accordion-body">
                                    <div class="row">
                                        ...
                                        @php($showSocialLinks = old('showSocialLinks', $member->showSocialLinks ?? false))
                                        <div class="col-md-6 mt-3">
                                            <div class="form-check mt-3">
                                ...
                                <div class="accordion-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="checkbox" id="showMeOnPublicWeb"
                                                    ...
                                                    {{ !is_null($member->contactDetails) && $member->contactDetails->showMeOnPublicWeb == 'Yes' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating">
                                                <input type="text"
                                                    ...
                                                    id="phone" name="phone"
                                                    value="{{ $member->contactDetails->phone ?? '' }}"
                                                    placeholder="phone">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="checkbox" id="showPhone"
                                                    name="showPhone" value="Yes"
                                                    {{ !is_null($member->contactDetails) && $member->contactDetails->showPhone == 'Yes' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="checkbox" id="showDirectNo"
                                                    ...
                                                    {{ !is_null($member->contactDetails) && $member->contactDetails->showDirectNo == 'Yes' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating">
                                                <input type="text"
                                                    ...
                                                    id="home" name="home"
                                                    value="{{ $member->contactDetails->home ?? '' }}" placeholder="home">
                                            ...
                                            <div class="col-md-6 mt-3 d-flex align-items-center">
                                                <div class="form-check">
                                                    <input class="form-check-input" type="checkbox" id="showMobileNo"
                                                        ...
                                                        {{ old('showMobileNo', $member->contactDetails->showMobileNo ?? 'No') == 'Yes' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating">
                                                <input type="text"
                                                    class="form-control @error('pager') is-invalid @enderror"
                                                    id="pager" name="pager"
                                                    value="{{ $member->contactDetails->pager ?? '' }}"
                                                    placeholder="pager">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="checkbox" id="showTollFree"
                                                    ...
                                                    {{ old('showTollFree', $member->contactDetails->showTollFree ?? 'No') == 'Yes' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating">
                                                <input type="text"
                                                    ...
                                                    id="fax" name="fax"
                                                    value="{{ $member->contactDetails->fax ?? '' }}" placeholder="fax">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="checkbox" id="showFax"
                                                    name="showFax" value="Yes"
                                                    {{ old('showFax', $member->contactDetails->showFax ?? 'No') == 'Yes' ? 'checked' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating">
                                                <input type="text"
                                                    ...
                                                    value="{{ $member->contactDetails->email ?? '' }}"
                                                    placeholder="email">
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-check mt-3">
                                                <input class="form-check-input" type="checkbox" id="showEmail"
                                                    name="showEmail" value="Yes"
                                                    {{ old('showEmail', $member->contactDetails->showEmail ?? 'No') == 'Yes' ? 'checked' : '' }}>
                            ...
                            <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                                ...
                                <div class="accordion-body">
                                    <div class="row">
                                                ...
                                                <select class="form-select @error('bCountry') is-invalid @enderror"
                                                    ...
                                                    @foreach ($countries as $country)
                                                        <option value="{{ $country->id }}"
                                                            {{ old('bCountry') == $country->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating">
                                                <select class="form-select @error('bCity') is-invalid @enderror"
                                                    id="bCity" name="bCity">
                                                    <option value="" selected>Select City</option>
                                                    @foreach ($cities as $city)
                                                        <option value="{{ $city->id }}"
                                                            {{ old('bCity', $member->billingAddress->bCity ?? '') == $city->id ? 'selected' : '' }}>
                                        ...
                                        <div class="col-md-6 mt-3">
                                            <div class="form-floating">
                                                <input type="text"
                                                    ...
                                                    value="{{ $member->contactDetails->pinCode ?? '' }}"
                                                    placeholder="pinCode">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="form-floating">
                                                    <input type="text"
                                                        ...
                                                        id="goals" name="goals"
                                                        value="{{ $member->goals ?? '' }}" placeholder="Goals">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="form-floating">
                                                    <input type="text"
                                                        ...
                                                        value="{{ $member->interests ?? '' }}" placeholder="interests">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="form-floating">
                                                    <input type="text"
                                                        ...
                                                        value="{{ $member->networks ?? '' }}" placeholder="networks">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="form-floating">
                                                    <input type="text"
                                                        ...
                                                        value="{{ $member->skills ?? '' }}" placeholder="skills">
                                    ...
                                    <div class="accordion-body">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="form-floating">
                                                    <input type="text"
                                                        ...
                                                        value="{{ $member->topsProfile->spouse ?? '' }}"
                                                        placeholder="spouse">
                                            ...
                                            <div class="col-md-6 mt-3">
                                                <div class="form-floating">
                                                    <input type="text"
                                                        class="form-control @error('pets') is-invalid @enderror"
                                                        id="pets" name="pets"
                                                        value="{{ $member->topsProfile->pets ?? '' }}"
                                                        placeholder="pets">
