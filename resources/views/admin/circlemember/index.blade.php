        ...
        <div class="card-body">
            ...
            <form method="GET" action="{{ route('circlemember.index') }}" id="filterForm">
                <div class="d-flex align-items-center mb-3 gap-3">
                    ...
                    <!-- ✅ Global Search -->
                    <input type="text" name="search" id="search" class="form-control mt-3"
                        placeholder="Search by name, circle, etc.." value="{{ request('search') }}">
                        ...
                        <tr>
                            ...
                            <td>
                                <div style="width: 80px; height: 80px; position: relative;">
                                    <img src="{{ asset('ProfilePhoto/' . ($circlememberData->profilePhoto ?? 'profile.png')) }}"
                                        alt="Profile Photo"
