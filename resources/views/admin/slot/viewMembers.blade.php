    ...
    <div class="card-container">
        ...
        <div class="card">
            ...
            <div class="btn-container">
                ...
                {{-- @if(isset($event) && $event->slot_date && !\App\Models\SlotBooking::where('eventId',
                $event->id)->where('userId', auth()->user()->member->id)->where('regMemberId',
                $visitorsUsersData->members->id ?? $visitorsUsersData->visitors->id)->exists())
                <button class="btn-slot-booking" data-bs-toggle="modal"
                    data-bs-target="#slotModal{{ $visitorsUsersData->id }}">
                    Slot Booking
                </button>
