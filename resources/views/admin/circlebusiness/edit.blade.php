...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form class="m-3 needs-validation" id="circleMemberBusForm" enctype="multipart/form-data" method="post" action="{{ route('busGiver.update', $busGiver->id) }}" novalidate>
                @csrf
                ...
                <div class="">
                    ...
                    <div class="form-floating mt-6">
                        <input type="hidden" name="businessGiverId" id="businessGiverId" value="{{ $busGiver->businessGiverId }}">
                ...
                <input type="hidden" name="referenceId" value="{{ $busGiver->referenceId }}">
                {{-- <div class="col-md-6">
                ...
                <div class="">
                    <div class="form-floating mt-3">
                        <input type="date" class="form-control @error('date') is-invalid @enderror" id="date" name="date" placeholder="date" required max="{{ date('Y-m-d') }}" value="{{ old('date', $busGiver->date) }}">
                ...
                <div class="">
                    <div class="form-floating mt-3">
                        <input type="remarks" class="form-control @error('remarks') is-invalid @enderror" id="remarks" name="remarks" placeholder="remarks" value="{{ old('remarks', $busGiver->remarks) }}">
                    ...
                    @if ($paymentHistory->isNotEmpty())
                        @foreach ($paymentHistory as $paymentHistoryData)
                            <tr>
                                ...
                                <td><a href="{{ route('busGiver.updatePayment', $paymentHistoryData->id) }}" class="btn btn-bg-blue btn-sm"><i class="bi bi-pen"></i></a></td>
                            </tr>
                        @endforeach
                    @else
                        <tr>
