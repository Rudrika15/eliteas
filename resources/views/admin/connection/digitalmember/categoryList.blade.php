        ...
        <div class="col-md-3">
            ...
            <div class="category-card d-flex justify-content-between align-items-center bg-white rounded shadow-sm p-2 mb-2"
                ...
                <div class="d-flex align-items-center gap-2">
                    ...
                    <img src="{{ $categoryData->categoryIcon ? asset('BusinessCategory/' . $categoryData->categoryIcon) : asset('img/logo2.jpg') }}"
    ...
    <div class="row">
        ...
        <div class="col-md-3">
            ...
            <div class="category-card d-flex justify-content-between align-items-center bg-white rounded shadow-sm p-2 mb-2"
                ...
                <div class="d-flex align-items-center gap-2">
                    <span class="fw-bold text-muted">{{ $index + 1 }}.</span>
                    <img src="{{ $categoryData->categoryIcon ? asset('BusinessCategory/' . $categoryData->categoryIcon) : asset('ProfilePhoto/profile.png') }}"
                        class="rounded-circle" width="40" height="40" alt="Category Icon">
                    <div>
                        <div class="fw-semibold">{{ $categoryData->categoryName ?? 'N/A' }}</div>
                    </div>
