...
<div class="card">
    ...
    <form class="m-3 needs-validation" id="circlememberForm" enctype="multipart/form-data" method="post"
        action="{{ route('digitalMember.update', $member->id) }}" novalidate>
        @csrf
                    ...
                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne"
                        ...
                        <div class="accordion-body">
                            <div class="row">
                                ...
                                <div class="col-md-6 mt-3">
                                    <div class="form-floating">
                                        <select class="form-select @error('cityId') is-invalid @enderror" id="cityId"
                                            name="cityId">
                                            <option value="" disabled>Select City</option>
                                            @foreach ($cities as $city)
                                            <option value="{{ $city->id }}" {{ old('cityId', $member->cityId) ==
                                                $city->id ? 'selected' : '' }}>
                                                {{ $city->cityName }}
                                            </option>
                                            @endforeach
