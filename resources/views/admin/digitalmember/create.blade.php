...
@section('content')
    ...
    <div class="card">
        <div class="card-body d-flex justify-content-between align-items-center">
            <h5 class="card-title">Create Digital Member</h5>
            <a href="{{ route('digitalMember.index') }}" class="btn btn-bg-orange btn-sm">BACK</a>
        </div>

        <!-- Floating Labels Form -->
        <form class="m-3 needs-validation" id="cityForm" enctype="multipart/form-data" method="post" action="{{ route('digitalMember.store') }}" novalidate>
            @csrf
            <div class="row mb-3">
                <div class="col-md-6">
