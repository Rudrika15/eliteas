...
<div class="card">
    ...
    <form class="m-3 needs-validation" id="trainingForm" enctype="multipart/form-data" method="post" action="{{ route('training.update', $training->id) }}" novalidate>
        @csrf
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="groupMember" id="internalMember" value="internalMember" {{ $training->trainers[0]->type == 'internalMember' ? 'checked' : '' }}>
                            <label class="form-check-label" for="internalMember">Internal</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="groupMember" id="externalMember" value="externalMember" {{ $training->trainers[0]->type == 'externalMember' ? '' : 'checked' }}>
                        ...
                        <div class="external-trainer-list" id="memberListInputMember" style="display:none;">
                            ...
                            <input type="text" class="form-control mt-3" id="trainerNameExternal" name="trainerNameExternal" placeholder="Trainer Name External" value="{{ $training->trainers[0]->user->firstName }} {{ $training->trainers[0]->user->lastName }}" readonly>
                        </div>
            ...
            <div class="col-md-6">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <!-- Trainer selection -->
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="group" id="internal" value="internal" {{ $training->trainers[1]->type == 'internal' ? 'checked' : '' }}>
                            <label class="form-check-label" for="internal">Internal</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="group" id="external" value="external" {{ $training->trainers[1]->type == 'external' ? '' : 'checked' }}>
                        ...
                        <div class="member-list" id="memberListDropdown" style="display:none;">
                            ...
                            <input type="text" class="form-control mt-3" id="trainerName2" name="trainerNameInternal" placeholder="Trainer Name Internal" value=" {{ $training->trainers[1]->user->firstName }} {{ $training->trainers[1]->user->lastName }}" readonly>
                        </div>
                        <div class="member-list" id="memberListInput" style="display:none;">
                            ...
                            <input type="text" class="form-control mt-3" id="trainerNameExternal2" name="trainerNameExternal2" placeholder="Trainer Name External" value="{{ $training->trainers[1]->user->firstName }} {{ $training->trainers[1]->user->lastName }}" readonly>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control mt-3" id="fees" name="fees" placeholder="Fees" value="{{ old('fees', $training->fees) }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <input type="text" class="form-control mt-3" id="meetingLink" name="meetingLink" placeholder="Meeting Link" style="display:none;" value="{{ old('meetingLink', $training->meetingLink) }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <div class="d-flex align-items-center mt-3">
                                        <label class="fw-bold me-3 mb-0">Training For :</label>
                                        ...
                                        <div class="form-check form-check-inline mb-0">
                                            <input class="form-check-input"
                                                ...
                                                id="training_offline"
                                                value="Offline"
                                                {{ old('training_for', $training->training_for) == 'Offline' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="training_offline">
                                                Offline
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check form-check-inline mb-0">
                                            <input class="form-check-input"
                                                ...
                                                id="training_digital"
                                                value="Digital"
                                                {{ old('training_for', $training->training_for) == 'Digital' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="training_digital">
                                                Digital
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check form-check-inline mb-0">
                                            <input class="form-check-input"
                                                ...
                                                id="training_all"
                                                value="All"
                                                {{ old('training_for', $training->training_for) == 'All' ? 'checked' : '' }}>
                                            <label class="form-check-label" for="training_all">
                                                All
                                            </label>
                                        </div>
                                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="time" class="form-control mt-3" id="time" name="time" placeholder="Time" value="{{ old('time', $training->time) }}">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control mt-3" id="duration" name="duration" placeholder="Duration" value="{{ old('duration', $training->duration) }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea class="form-control mt-3" id="note" name="note" placeholder="Note" rows="3">{{ old('note', $training->note) }}</textarea>
                                </div>
                            </div>
