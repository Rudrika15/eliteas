                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="groupMember"
                                id="internalMember" value="internalMember" {{ $training->trainers[0]->type ==
                            'internalMember' ? 'checked' : '' }}>
                            <label class="form-check-label" for="internalMember">Internal</label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="groupMember"
                                id="externalMember" value="externalMember" {{ $training->trainers[0]->type ==
                            'externalMember' ? '' : 'checked' }}>
                        ...
                        <div class="member-list" id="memberListDropdownMember">
                            ...
                            $training->trainers[0]->type == 'internalMember') value="{{$training->trainers[0]->userId}}"
                            @endif>
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="group" id="internal"
                                value="internal" {{ $training->trainers[1]->type == 'internal' ? 'checked' : '' }}>
                        ...
                        <div class="form-check">
                            <input class="form-check-input trainer-radio" type="radio" name="group" id="external"
                                value="external" {{ $training->trainers[1]->type == 'external' ? '' : 'checked' }}>
                        ...
                        <div class="member-list" id="memberListDropdown" style="display:none;">
                            ...
                            $training->trainers[1]->type == 'internalMember') value="{{$training->trainers[1]->userId}}"
                            @endif>
                        ...
                        <div class="member-list" id="memberListInput" style="display:none;">
                            ...
                            <input type="text" class="form-control mt-3" id="trainerNameExternal2"
                        ...
                        <input type="text" class="form-control mt-3" id="trainerEmail2" name="email2"
                            placeholder="Email" value="{{$training->trainers[1]->user->email}}" readonly>
                    </div>
                </div>
                @else
                <h5><b>Trainer 2</b></h5>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="text" class="form-control mt-3" id="title" name="title"
                                        placeholder="Title" value="{{ old('title', $training->title) }}">
                                </div>
                                <div class="col-md-6">
                                    <input type="text" class="form-control mt-3" id="fees" name="fees"
                                        placeholder="Fees" value="{{ old('fees', $training->fees) }}">
                                </div>
                                <div class="col-md-6">
                                    <select class="form-select mt-3" id="type" name="type">
                                        ...
                                        <option value="Offline" {{ old('type', $training->type) == 'Offline' ?
                                            'selected' : ''
                                            }}>Offline</option>
                                    </select>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <input type="time" class="form-control mt-3" id="time" name="time"
                                        placeholder="Time" value="{{ old('time', $training->time) }}">
                                </div>
                                <div class="col-md-6">
