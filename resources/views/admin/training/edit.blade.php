            ...
            <div class="col-md-6">
                    ...
                    <div class="col-sm-6">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="groupMember" id="internalMember"
                                value="internalMember" {{ old('groupMember')=='internalMember' ? 'checked' : '' }}>
                    ...
                    <div class="col-sm-6">
                        <div class="form-check">
                            <input class="form-check-input" type="radio" name="groupMember" id="externalMember"
                                value="externalMember" {{ old('groupMember')=='externalMember' ? 'checked' : '' }}>
                ...
                <div class="row pt-5">
                    <div class="col-md-4" id="memberListDropdownMember" style="">
                        ...
                        <div class="col-md-12">
                            <input type="hidden" id="trainerId" name="memberId" value="{{ old('memberId') }}">
                            <div class="form-floating">

                                <!-- Searchable input field -->
                                <input type="text" name="memberName" class="form-control" id="trainerName"
                                    name="memberName" placeholder="Select Member" value="{{ old('memberName') }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating mt-3">
                            <input type="text" class="form-control @error('contactNo') is-invalid @enderror"
                                id="trainerContact" placeholder="Contact No" value="{{ old('contactNo') }}">
                    ...
                    <div class="col-md-12">
                        <div class="form-floating mt-3">
                            <input type="text" class="form-control @error('email') is-invalid @enderror"
                                id="trainerEmail" name="email" placeholder="email" value="{{ old('email') }}">
                ...
                <div class="col-md-12">
                    <div class="form-floating mt-3">
                        <input type="text" class="form-control @error('email') is-invalid @enderror" id="trainerEmail2"
                            name="email2" placeholder="email2" value="{{ old('email2') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control @error('fees') is-invalid @enderror"
                                        id="fees" name="fees" placeholder="Fees" value="{{ old('fees') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mt-3">
                                    <input type="text" class="form-control @error('venue') is-invalid @enderror"
                                        id="venue" name="venue" placeholder="Venue" value="{{ old('venue') }}">
                            ...
                            <div class="col-md-6">
                                <div class="form-floating mt-3">
                                    <input type="time" class="form-control @error('time') is-invalid @enderror"
                                        id="time" name="time" placeholder="Time" value="{{ old('time') }}">
                            ...
                            <div class="col-md-12">
                                <div class="form-floating mt-3">
                                    <textarea class="form-control @error('note') is-invalid @enderror" id="note"
                                        name="note" placeholder="Note" rows="3">{{ old('note') }}</textarea>
