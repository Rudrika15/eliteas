...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            <h4 class="mb-0 mt-3">Circle Type</h4>
            <a href="{{ route('circletype.create') }}" class="btn btn-bg-orange btn-sm mt-3"><i class="bi bi-plus-circle"></i></a>
        </div>
        ...
        <table class="table datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('circletype.edit', $circleData->id) }}" class="btn btn-bg-blue btn-sm">
                            <i class="bi bi-pen"></i>
                        </a>
                        ...
                        <a href="{{ route('circletype.delete', $circleData->id) }}" class="btn btn-danger btn-sm">
