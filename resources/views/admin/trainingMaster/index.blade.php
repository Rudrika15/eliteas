        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('trainingMaster.create') }}" class="btn btn-bg-orange btn-sm mt-2 btn-tooltip"><i class="bi bi-plus-circle"></i>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($trainingMaster as $trainingMasterData)
                                <tr>
                                    <th>{{ ($trainingMaster->currentPage() - 1) * $trainingMaster->perPage() + $loop->index + 1 }}
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('trainingMaster.delete', $trainingMasterData->id) }}" class="btn btn-danger btn-sm btn-tooltip">
