...
<div class="card">
    <div class="card-body">
        <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <a href="{{ route('franchise.create') }}" class="btn btn-bg-orange btn-sm mt-3"><i class="bi bi-plus-circle"></i></a>
        </div>
        ...
        <table class="table datatable">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        <a href="{{ route('franchise.edit', $franchiseData->id) }}" class="btn btn-bg-blue btn-sm">
                            <i class="bi bi-pen"></i>
                        </a>
