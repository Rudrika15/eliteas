...
@endif --}}
    ...
    <script>
        // Function to toggle visibility of specific fields
        document.getElementById('managedByUbn').addEventListener('change', function() {
            // List of fields to hide/show based on checkbox state
            const fields = ['firstName', 'lastName', 'email', 'franchiseContactDetails'];

            fields.forEach(function(fieldId) {
                const field = document.getElementById(fieldId).closest('.form-floating');
                if (field) {
    ...
    <script>
        document.getElementById('managedByUbn').addEventListener('change', function() {
            ...
            // List of fields to hide/show and make required/not required
            const fields = ['firstName', 'lastName', 'email', 'franchiseContactDetails'];

            fields.forEach(function(fieldId) {
                const fieldElement = document.getElementById(fieldId);
                const fieldContainer = fieldElement.closest('.form-floating');

                // Toggle visibility
                fieldContainer.style.display = isChecked ? 'none' : 'block';

                // Toggle required attribute
                fieldElement.required = !isChecked;
            });
        });

        // Run the function initially to set the correct state on page load
        document.getElementById('managedByUbn').dispatchEvent(new Event('change'));
    </script>
