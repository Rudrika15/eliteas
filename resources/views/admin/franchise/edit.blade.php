            ...
            <div class="col-md-6">
                <div class="form-floating">
                    <input type="text" class="form-control @error('franchiseContactDetails') is-invalid @enderror"
                        ...
                        value="{{$franchises->franchiseContactDetails ?? '-'}}" placeholder="Franchise Contact Details"
                        required>
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <select class="form-select @error('cityId') is-invalid @enderror" id="cityId" name="cityId"
                        ...
                        <option value="{{ $city->id }}" {{ $city->id == old('cityId', $franchises->cityId) ? 'selected'
                            : '' }}>
                            {{ $city->cityName }}
                        </option>
                        @endforeach
