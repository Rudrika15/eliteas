...
<div class="card">
    <div class="card-body d-flex justify-content-between align-items-center">
        <h5 class="card-title">Create Circle Meeting</h5>
    ...
    <form class="m-3 needs-validation" id="circlemeetingForm" enctype="multipart/form-data" method="post"
        action="{{ route('circlemeeting.store') }}" novalidate>
        @csrf
        <div class="row mb-3">
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="datetime-local" class="form-control @error('dateTime') is-invalid @enderror" id="dateTime"
                        name="dateTime" placeholder="Date & Time" required>
                    <label for="cityName">Date & Time</label>
                    @error('dateTime')
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="text" class="form-control @error('hotelName') is-invalid @enderror"
                        id="hotelName" name="hotelName" placeholder="Hotel Name" required>
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="text" class="form-control @error('totalMeeting') is-invalid @enderror"
                        id="totalMeeting" name="totalMeeting" placeholder="Total Meeting" required>
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="text" class="form-control @error('refGiven') is-invalid @enderror" id="refGiven"
                        name="refGiven" placeholder="Total Reference Given" required>
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="text" class="form-control @error('refTaken') is-invalid @enderror" id="refTaken"
                        name="refTaken" placeholder="Total Reference Taken" required>
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="text" class="form-control @error('busGiven') is-invalid @enderror" id="busGiven"
                        name="busGiven" placeholder="Total Business Given" required>
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="text" class="form-control @error('busTaken') is-invalid @enderror" id="busTaken"
                        name="busTaken" placeholder="Total Business Taken" required>
