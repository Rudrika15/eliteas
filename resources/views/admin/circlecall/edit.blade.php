    ...
    <form class="m-3 needs-validation" id="callForm" enctype="multipart/form-data" method="post"
        ...
        <div class="row mb-3 mt-3">
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    <input type="text" class="form-control" id="meetingPlace" name="meetingPlace"
                        placeholder="Meeting Place Name" pattern="[A-Za-z\s]+" required value="{{ old('meetingPlace', $circlecall->meetingPlace) }}"
            ...
            <div class="col-md-6">
                ...
                <div class="mt-1">
                    <img id="photoPreview" src="{{ ($oldMeetingImage) ? $oldMeetingImage : asset('img/profile.png') }}" alt="Meeting Image" style="width: 100px; height: 100px; object-fit: contain; aspect-ratio: 1/1;" />
                </div>
            </div>
            ...
            <div class="col-md-6">
                <div class="form-floating mt-3">
                    ...
                    <input type="date" class="form-control" id="date" name="date" placeholder="Meeting Date" required
                        min="{{ $lastDate }}" max="{{ $nearestDate }}" value="{{ old('date', $selectedDate) }}" disabled>
...
$(document).ready(function() {
    ...
    var defaultMemberId = '{{ old('memberId', $circlecall->meetingPerson->memberId) }}'; // Get the default member ID
