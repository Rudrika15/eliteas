    ...
    <div class="card">
        <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <select name="memberId" id="memberId" class="form-control form-control-sm">
                            ...
                            <option value="{{ $m->userId }}" {{ request('memberId')==$m->userId ? 'selected' : '' }}>
            ...
            <div class="text-end mb-2">
                <a href="{{ route('admin.memberWiseReport', request()->all()) }}" class="btn btn-success btn-sm">Export
                    Excel</a>
            </div>
            @endif --}}
            ...
            <div class="mt-4">
                <h5 class="fw-bold color-orange">Report for: <span class="color-blue">{{ $selectedMember->firstName }}
                        {{ $selectedMember->lastName }} </span></h5>
                <h5 class="fw-bold">Date : {{ \Carbon\Carbon::parse($startDate)->format('d-m-Y') }} To {{
            ...
            <div class="mt-5">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($ibm->meetingPersonId == $selectedMemberId)
            ...
            <div class="mt-4">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($b->loginMemberId == $selectedMemberId)
                                {{ $b->businessGiver->firstName ?? '' }} {{ $b->businessGiver->lastName ?? '' }}
                                @else
            ...
            <div class="mt-4">
                ...
                <table class="table table-bordered table-sm">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                @if($r->memberId == $selectedMemberId)
                                {{ $r->refGiverName->firstName ?? '' }} {{ $r->refGiverName->lastName ?? '' }}
                                @else
