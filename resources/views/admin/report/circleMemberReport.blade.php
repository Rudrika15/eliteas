    ...
    <div class="card">
        <div class="card-body">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="circleId" id="circleId" class="form-control form-control-sm">
                            ...
                            <option value="{{ $circle->id }}" {{ request()->input('circleId') == $circle->id ?
                                'selected' : '' }}>
                                {{ $circle->circleName }}
                            </option>
                            @endforeach
            ...
            <div class="accordion mt-4" id="memberDetailsAccordion">
                ...
                @php $uid = $row['memberUserId']; $det = $details[$uid] ?? ['ibms'=>[], 'references'=>[],
                'businesses'=>[]]; @endphp
                <div class="accordion-item">
                    ...
                    <div id="collapse-{{ $uid }}" class="accordion-collapse collapse"
                        aria-labelledby="heading-{{ $uid }}" data-bs-parent="#memberDetailsAccordion">
