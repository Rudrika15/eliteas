...
@section('title', 'UBN - Circle Activity Report')
@section('content')
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title">Circle Activity Report</h4>
                    <div>
                        <form method="GET" action="{{ route('admin.report.circleActivity') }}">
                ...
                <form method="GET" action="{{ route('admin.report.circleActivity') }}" id="filterForm">
                    <div class="row mb-3">
                        <div class="col-md-4">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            ...
                            <a href="{{ route('admin.report.circleActivity') }}" class="btn btn-secondary ms-2">Reset</a>
                        </div>
                    </div>
                </form>
