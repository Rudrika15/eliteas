...
<div class="container my-4">
    <div class="card shadow-sm border-0">
        <div class="card-body mt-3">
            ...
            <form method="GET" action="{{ route('vp.report') }}" class="mb-4">
                <div class="row g-3 align-items-center">
                    ...
                    <div class="col-md-6 d-flex gap-2 mt-4 justify-content-end">
                        ...
                        <a href="{{ route('vp.report.export', request()->all()) }}" class="btn text-white"
                            style="background:#e76a35;">
            ...
            {{-- Show Reports only when filter is applied --}}
            ...
            <div class="row text-center mb-4">
                ...
                <div class="col-md-4">
                    <div class="p-3 rounded shadow-sm border" style="background:#f8f9fa;">
                        <h6 class="text-muted">Total IBM</h6>
                        <h3 class="fw-bold" style="color:#1d3268;">{{ $totalIbmParticipations }}</h3>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="p-3 rounded shadow-sm border" style="background:#f8f9fa;">
                ...
                <div class="card-body p-0">
                    <table class="table table-striped table-hover mb-0">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $row['member'] }}</td>
                                <td class="fw-bold" style="color:#1d3268;">₹{{ number_format($row['total_amount'], 2) }}
                                </td>
                            </tr>
                            @endforeach
                        </tbody>
