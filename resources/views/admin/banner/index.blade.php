        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="{{ route('banner.create') }}" class="btn btn-bg-orange btn-sm mt-3 btn-tooltip"><i class="bi bi-plus-circle"></i>
                        <span class="btn-text">Add Banner</span>
                    </a>
                </div>
                    ...
                    <table class="table table-bordered table-striped table-hover">
                        ...
                        <tbody>
                            @foreach ($banners as $bannerData)
                                <tr>
                                    <th>{{ ($banners->currentPage() - 1) * $banners->perPage() + $loop->index + 1 }}

                                    <td>{{ $bannerData->title ?? '-' }}</td>
                                    <td>
                                        @if ($bannerData->image)
                                            <img src="{{ asset('banners/' . $bannerData->image) }}" alt="{{ $bannerData->image }}" width="150" height="100">
                                        @else
                                            -
                                        @endif
                                    </td>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('banner.edit', $bannerData->id) }}" class="btn btn-bg-blue btn-sm btn-tooltip">
                                            <i class="bi bi-pen"></i>
                                            <span class="btn-text">Edit</span>
                                        </a>

                                        <a href="{{ route('banner.delete', $bannerData->id) }}" class="btn btn-danger btn-sm btn-tooltip">
