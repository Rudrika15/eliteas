                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-floating">
                                    <input type="longText"
                                        ...
                                        name="myBusiness" value="{{ $member->myBusiness ?? '-' }}"
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-floating">
                                    <input type="text" class="form-control @error('fax') is-invalid @enderror" id="fax"
                                        name="fax" value="{{ $contactDetails->fax ?? '-' }}" placeholder="fax">
                ...
                <div id="collapseSix" class="accordion-collapse collapse" aria-labelledby="headingSix"
                    ...
                    <div class="accordion-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-floating">
                                    <select class="form-control @error('bState') is-invalid @enderror" id="bState"
                                        name="bState">
                            ...
                            <div class="col-md-6 mt-3">
                                <div class="form-floating">
                                    <select class="form-control @error('bCountry') is-invalid @enderror" id="bCountry"
                                        name="bCountry">
