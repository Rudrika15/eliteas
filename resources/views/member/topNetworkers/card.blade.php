    ...
    <div class="fb-card-body">
        ...
        <div class="fb-card-info">
            ...
            @if (!empty($member->companyName))
                <div class="text-truncate" title="{{ $member->companyName }}"><i class="bi bi-building me-1"></i> {{ $member->companyName }}</div>
            @endif
            @if (!empty($member->bCategory->categoryName))
                <div class="text-truncate" title="{{ $member->bCategory->categoryName }}"><i class="bi bi-tag me-1"></i> {{ $member->bCategory->categoryName }}</div>
            @endif
        </div>
