                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-1 mt-2 ">
                                    <button type="button" class="btn btn-bg-blue btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                        Invite
                                    </button>
                                </div>
                            </div>
                            <div class="accordion-item mt-3">
                                <h2 class="accordion-header " id="headingSix">
                                    <button class="accordion-button form-select" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                    ...
                                    <div class="col-md-4">
                                        @if (count($findRegister) == 0)
                                            @if ($nearestTraining->fees == 0)
                                                ...
                                                <button type="button" class="btn btn-bg-blue btn-md" data-bs-toggle="modal" data-bs-target="#staticBackdrop">
                                                    Register
                                                </button>
                                            @else
                            ...
                            <div>
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item text-center fw-bold">
                                        <button type="button" class="btn btn-primary btn-sm mt-2" data-bs-toggle="modal" data-bs-target="#allInvitesModal">
                                            Show More...
                                        </button>
                                    </li>
                                </ul>
